...
Mô tả:
File này hướng dẫn kiểm tra các thành phần hạ tầng đã được triển khai trên AWS (VPC, Subnets, Internet Gateway, Route Tables, NAT Gateway, EC2 Instances, và Security Groups) bằng AWS CLI.
...
Internet Gateway có trạng thái "available".
...
Có một route với DestinationCidrBlock: 0.0.0.0/0 và GatewayId: igw-xxxxxxxx.
...
Có một route với DestinationCidrBlock: 0.0.0.0/0 và NatGatewayId: nat-xxxxxxxx.
...
Trạng thái của NAT Gateway là "available".
...
EC2 instance có PublicIpAddress.
Trạng thái "State.Name": "running".
...
Có rule "FromPort": 22 và "IpRanges": [{"CidrIp": "your-ip-address/32"}].
...
Có rule "FromPort": 22 và "UserIdGroupPairs" chỉ đến Security Group của Public EC2.